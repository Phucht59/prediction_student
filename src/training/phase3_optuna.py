...
def objective_for(
    runner: Phase3OptunaRunner, outer_fold: int, sampler_seed: int
):
...
def run_smoke() -> dict[str, Any]:
    ...
    runner = Phase3OptunaRunner(bundle, outer_fold=0)
...
def _run_control(
    runner: Phase3OptunaRunner, outer_fold: int
) -> dict[str, Any]:
...
def _run_stability(
    runners: dict[int, Phase3OptunaRunner],
...
def run_supervisor() -> int:
    ...
    try:
        ...
        bundle = oulad._build_bundle()
        runners = {
            outer_fold: Phase3OptunaRunner(bundle, outer_fold)
