"""Mask-safe CNN/BiLSTM components from the approved Phase8 source bundle."""
...
class ResidualProjector(nn.Module):
    """Train-fitted static/aggregate projector used by frozen Phase8 Hybrid."""
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        return self.norm(self.shortcut(x) + self.deep(x))
