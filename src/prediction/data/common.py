"""Dataset-neutral D3/F3 input contract."""
...
class UnifiedHybridData:
    ...
    def validate(self) -> None:
        ...
        if any(len(x) != n for x in (self.group_id, self.target, self.lengths, self.aggregate_available, self.progress)):
            raise ValueError("record-aligned fields have inconsistent lengths")
