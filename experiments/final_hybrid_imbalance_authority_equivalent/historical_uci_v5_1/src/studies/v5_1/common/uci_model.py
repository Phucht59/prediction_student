...
class UCITemporalEncoderV51(nn.Module):
...
class UCIContextEncoderV51(nn.Module):
...
class UCIHybridV51(nn.Module):
    ...
    def __init__(self, temporal_dim: int, context_dim: int, config: dict[str, Any]):
        ...
        self.temporal = UCITemporalEncoderV51(temporal_dim, config)
        self.context = UCIContextEncoderV51(context_dim, context_hidden, context_layers, dropout)
...
__all__ = [
    "SameLengthConv1d",
    "UCIContextEncoderV51",
    "UCIHybridV51",
    "UCITemporalEncoderV51",
    "count_parameters",
    "gate_statistics",
]
