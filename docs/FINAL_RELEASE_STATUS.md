...
- Release tags: `thesis-project-postgresql-final-v2` and live-verified
  `thesis-project-live-postgresql-final-v3`.
...
- Active evidence: `artifacts/final/final-5a0b5041-5216-4a48-9e46-b0c16ab14866/`.
...
- `source_record_targets`: present with 395 rows; 0 duplicates and 0 orphans.
